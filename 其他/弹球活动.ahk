;===TFM活动提醒脚本[24-12-6活动专版（识别符Pinball Chimney）]===
;===识别到左上角活动地图代号(固定出现的字符),执行3705行后的操作===
;===绑定Tfm游戏窗口(使用版本为Steam或官网版本)===
;===禁止多开Steam或官网版本(包括同时使用2版本），否则无法识别===
;===如需多账号使用（不使用本脚本），可以用支持flash的浏览器（CEF浏览器、360极速浏览器）、flash大厅（最好不用）等

; 解绑窗口使用 FindText().BindWindow(0)
SetTitleMatchMode 2
id:=WinExist("Transformice ahk_class ApolloRuntimeContentWindow")
FindText().BindWindow(id,4)  

; #Include <FindText>

t1:=A_TickCount, Text:=X:=Y:=""

Text:="|<>**50$98.0C0Q01y00sC00000DuU500KUTu2U000023s1E05cA6Us00000iTzLnxO6QjjzzyDiuqoQ6VqVB+CkFcqCehgvAjBcK2RgnNrRijPOrfvO50hPRqpjNcCoh/UqVM/KpJdM7Kyh/KrhcKCZhJOKzFc/GrBvO6ydPJKZbqO2og7UqUkOKpJdQ4jUzDzDzs7zbzRyRzO0000000000000005U000000000000001m"

if (ok:=FindText(&X, &Y, 108-150000, 12-150000, 108+150000, 12+150000, 0, 0, Text))
{
...
;声音提醒
;参数1数字越高，声音越尖，越小相反，限定区间(37-32767)
;参数2为时间（毫秒）
SoundBeep 750, 2000
